...
- [EFTEC/BladeOne](https://github.com/EFTEC/BladeOne) ([4.17.1](https://github.com/EFTEC/BladeOne/releases/tag/4.17.1), 3 weeks ago) - The standalone version Blade Template Engine without Laravel in a single php file and without dependencies
- [scrawler-labs/http](https://github.com/scrawler-labs/http) ([v2.1.1](https://github.com/scrawler-labs/http/releases/tag/v2.1.1), 2 months ago) - Scrawler Http Foundation is a wrapper around Symphony Http Foundation with added features
