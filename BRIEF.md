...
- [scrawler-labs/blade](https://github.com/scrawler-labs/blade) - Blade Integration for Scrawler, Based on BladeOne (4 months ago)
...
- [scrawler-labs/csrf](https://github.com/scrawler-labs/csrf) ([v1.0.1](https://github.com/scrawler-labs/csrf/releases/tag/v1.0.1), today) - csrf protection for scrawler framework
- [scrawler-labs/scrawler](https://github.com/scrawler-labs/scrawler) ([v2.3.0](https://github.com/scrawler-labs/scrawler/releases/tag/v2.3.0), 2 days ago) - Create simple but powerful web apps and APIs quickly, with minimum lines of code
