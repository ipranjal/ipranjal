...
- [scrawler-labs/arca-orm](https://github.com/scrawler-labs/arca-orm) ([v1.1.2](https://github.com/scrawler-labs/arca-orm/releases/tag/v1.1.2), 3 days ago) -  Low code , Zero Configuration ORM that creates models, config, database and tables on the fly.
