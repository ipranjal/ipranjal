...
- [scrawler-labs/arca-orm](https://github.com/scrawler-labs/arca-orm) ([v2.0.0](https://github.com/scrawler-labs/arca-orm/releases/tag/v2.0.0), 5 days ago) -  Low code , Zero Configuration ORM that creates models, config, database and tables on the fly.
